import{_ as t,r as c,o,c as d,b as s,e as n,w as p,d as a,a as i}from"./app-De5JuplM.js";const r={},v=s("h2",{id:"目录",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#目录"},[s("span",null,"目录")])],-1),u={class:"table-of-contents"},k=s("h2",{id:"简单配置",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#简单配置"},[s("span",null,"简单配置")])],-1),m={href:"https://www.cnblogs.com/zhongweiv/p/nginx_conf.html",target:"_blank",rel:"noopener noreferrer"},b=i(`<div class="language-nginx line-numbers-mode" data-highlighter="prismjs" data-ext="nginx" data-title="nginx"><pre class="language-nginx"><code><span class="line"><span class="token comment">#user nobody;</span></span>
